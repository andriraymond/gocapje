...
export default function Products() {
    ...
    return (
        <div className={styles.product}>
            {loading ? (
                <>
                <div className={styles["container-product-title-skeleton"]}></div>
                <div className={styles["product-wrapper-skeleton"]}></div>
                </>

            ) : (
                <>
                <section className={styles['container-product-title']}>Produk Pilihan dari Brand Populer</section>
